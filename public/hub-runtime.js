    const CATEGORY = {"key":"financas","short":"FINANÇAS","label":"Finanças pessoais e organização","host":"finance.toppapps.online","title":"Soluções para organizar decisões financeiras com mais clareza.","description":"Guias e ferramentas digitais para reunir informações, escolher prioridades e construir uma rotina financeira possível.","accent":"#b34b3d","accent_soft":"#f6e9e5","hero_asset":"/assets/hero-financas-1.webp","hero_alt":"Ilustração editorial de organização financeira com caderno, moedas e gráfico","slides":[{"title":"Clareza antes de cortar tudo.","copy":"Comece entendendo entradas, saídas e decisões que merecem atenção no seu momento.","image":"/assets/hero-financas-1.webp","alt":"Destaque editorial 1 de FINANÇAS"},{"title":"Uma rotina financeira precisa caber na vida.","copy":"Escolha uma solução por objetivo e avance com um próximo passo observável.","image":"/assets/hero-financas-2.webp","alt":"Destaque editorial 2 de FINANÇAS"},{"title":"Organização também é reduzir ruído.","copy":"Reúna as informações essenciais e compare caminhos com mais tranquilidade.","image":"/assets/hero-financas-3.webp","alt":"Destaque editorial 3 de FINANÇAS"}],"collections":[["começar","Começar pela organização","Para colocar o mês em uma visão simples e possível."],["dividas","Lidar com dívidas","Para reunir obrigações e preparar decisões sem improviso."],["rotina","Criar uma rotina","Para acompanhar o dinheiro e revisar o que mudou."]],"products":[{"slug":"o-salario-sumiu","title":"O Salário Sumiu","subtitle":"Mapa do Dinheiro","description":"Liste o que entra, o que sai e o que não tem nome. Em 15 minutos o mapa do mês aparece.","objective":"Organização financeira","theme":"Visão do mês","audience":"Quem quer entender o próprio mês","format":"Guia digital + aplicação","delivery":"Entrega digital","price":27.9,"status":"live","priority":1,"collection":"começar","tags":["salário","dinheiro","gastos","mês","organização"],"featured":true,"cover":"/assets/covers/o-salario-sumiu.webp"},{"slug":"30-dias-organizar","title":"30 Dias Para Organizar Sua Vida Financeira","subtitle":"Ritmo de 30 Dias","description":"Uma ação curta por dia para ver, organizar, decidir e manter uma rotina possível.","objective":"Rotina e planejamento","theme":"Hábitos financeiros","audience":"Quem precisa de constância","format":"Plano de aplicação","delivery":"Entrega digital","price":37.9,"status":"live","priority":2,"collection":"rotina","tags":["30 dias","rotina","planejamento","hábitos","organizar"],"featured":true,"cover":"/assets/covers/30-dias-organizar.webp"},{"slug":"adeus-dividas","title":"Adeus Dívidas","subtitle":"Plano de Ataque às Dívidas","description":"Reúna obrigações, compare informações e prepare a próxima conversa com mais clareza.","objective":"Dívidas","theme":"Priorização","audience":"Quem precisa organizar obrigações","format":"Guia digital + aplicação","delivery":"Entrega digital","price":37.9,"status":"live","priority":3,"collection":"dividas","tags":["dívidas","obrigações","prioridade","negociação","acordo"],"featured":true,"cover":"/assets/covers/adeus-dividas.webp"},{"slug":"reserva-de-emergencia-do-zero","title":"Reserva de Emergência do Zero","subtitle":"Primeira Reserva","description":"Um caminho planejado para começar uma reserva com critérios, sem tratar metas financeiras como promessa de resultado.","objective":"Reserva e proteção","theme":"Planejamento","audience":"Quem quer começar do zero","format":"Guia digital","delivery":"Publicação em preparação","price":null,"status":"planned","priority":4,"collection":"começar","tags":["reserva","emergência","proteção","começar do zero"],"featured":false,"cover":"/assets/covers/reserva-de-emergencia-do-zero.webp"}],"faqs":[["Como escolher uma solução?","Use o objetivo e o momento que mais se aproximam da sua necessidade. A página individual explica o que está incluído e o próximo passo."],["As soluções prometem resultado financeiro?","Não. Elas organizam informação, reflexão e aplicação. O resultado externo depende das suas decisões, contexto e execução."],["Como recebo o acesso?","As condições de acesso, pagamento e eventual garantia devem estar confirmadas na página oficial da oferta antes da compra."]]};
